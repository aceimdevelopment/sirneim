...
$ ->
  if aceim.es_accion("registrar") or aceim.es_accion("registrar_guardar") or aceim.es_accion("registrar_datos_profesionales") or aceim.es_accion("registrar_datos_profesionales_guardar")
